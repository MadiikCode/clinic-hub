    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('user', 'User'), ('doctor', 'Doctor'), ('clinic_staff', 'Clinic Staff'), ('admin', 'Admin')], default='user', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('doctor', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='doctors_app.doctor')),
                ('service', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='appointments', to='clinic_app.service', verbose_name='Услуга')),
            ...
            options={
                ...
                'ordering': ['date', 'time'],
                'indexes': [models.Index(fields=['date'], name='users_app_a_date_c65860_idx'), models.Index(fields=['status'], name='users_app_a_status_fbb31b_idx'), models.Index(fields=['created_at'], name='users_app_a_created_b8b60a_idx'), models.Index(fields=['updated_at'], name='users_app_a_updated_7578d1_idx')],
            },
        ),
    ]
